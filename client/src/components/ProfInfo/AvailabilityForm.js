...
function GameStyleForm(props) {
  // const name = props.name.notName;
  return (
    <div>
      <Typography className="formTitle">Please share your weekly availability (days and times)!</Typography>
