...
const AboutUs = (props) => {
        ...
        const {classes}=props;
          ...
          <p>
            DnD Party Finder is a one-stop-shop for all the Dungeons and Dragons enthusiasts. 
            From finding new players to join your party to learning more about the game dynamics, DnD Party Finder will help you navigate through the path of becoming the best Necromancer.
            We hope this website allows you to connect with people and fosters a community like environment.
          </p>

          <h3>The Developers</h3>

          
             <p>Adrián Cruz - Front-End</p>
             <br></br>
             <p>Kent Valle - Back-End</p>
             <br></br>
